...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
								<li><a href="https://www.linkedin.com/in/ankit-dubey-sir/" class="fa fa-facebook icon-border facebook"> </a></li>
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">ankitdubey7525@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+919794499725</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">ANKIT<span>HOTEL</span><p class="logo_w3l_agile_caption">Booking Management System</p></a></h1>
				</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our ANKIT HOTEL</h3> 
						   <p class="about-para-w3ls">Book Now & Save Big at Agoda®! Always The Lowest Price Guarantee. We Have Over 40 Payment Ways for Locking the Lowest Room Rates. No Credit Card Needed! 63,000 Cities Worldwide. Flash Deals. 23 Million+ Customers. Secure Payments. Easy & Fast Booking.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>This hote is design by Ankit </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Meet Our Friends</h3>
			<div id="horizontalTab">
					<ul class="resp-tabs-list">
					<li style="height: 150px; width: 150px;">
						<img src="images/aryan1.jpg" alt=" " class="img-responsive"/>
					</li>
					<li style="height: 120px; width: 150px;">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Ankit Dubey</h4>
							<span>Manager</span>
							<p>Hotel manager skill are the abilities that help you function as a hotel manager and undertake the resposibiliteis involved with the role.</p>
					...
					<ul class="slides">
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/aryan.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+919794499725</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">ankitdubey7525@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Pratapgarh Uttar Pradesh India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 ANKIT HOTEL.  | Design by <a href="index.php">ANKIT Dubey</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
